...
public class Population
{
    ...
    final static int POP_SIZE = 200 + ELITISM_K;  
    ...
    //@param m_rand  random-number generator
    ...
    public Individual findBestIndividual() {
      ...
      //  System.out.print("best individual found at " + idxMax);
    ...
    public static void main(String[] args) {
        ...
        for (int iter = 0; iter < MAX_ITER; iter++) {
           ...
           //   System.out.print("Current iteration is " + count);
            }
